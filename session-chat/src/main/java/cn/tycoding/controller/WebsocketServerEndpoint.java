...
public class WebsocketServerEndpoint {
    ...
    private static CopyOnWriteArraySet<WebsocketServerEndpoint> websocketServerEndpoints = new CopyOnWriteArraySet<WebsocketServerEndpoint>();
    ...
    public void onOpen(Session session, @PathParam("id") String id, EndpointConfig config) {
        ...
        try {
            ...
            if (attribute instanceof ChatUser) {
                user = (ChatUser) attribute;
            }
            //群发消息
    ...
    private String getData(String toId, String message) throws IOException {
        ...
        if (from instanceof ChatUser) {
            entity.setFrom((ChatUser) from);
        }
