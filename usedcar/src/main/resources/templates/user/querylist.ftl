        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    ...
                    <#if userPage.getTotalPages() lte 1>
                    <#else>
                        <#if currentPage lte 1>
                            <li class="disabled"><a href="#">上一页</a></li>
                        <#else>
                            <li><a href="/goToQuery?page=${currentPage - 1}&size=${size}&queryName=${name}">上一页</a></li>
                        </#if>
                        ...
                        <#list 1..userPage.getTotalPages() as index>
                            ...
                            <#else>
                                <li><a href="/goToQuery?page=${index}&size=${size}&queryName=${name}">${index}</a></li>
                            </#if>
                        </#list>
                        ...
                        <#else>
                            <li><a href="/goToQuery?page=${currentPage + 1}&size=${size}&queryName=${name}">下一页</a></li>
                        </#if>
                    </#if>
                    </ul>
                </div>
